          ...
          <div className="footer__container_connect">
            ...
            <Link href="tel:+7 (922) 640-16-66">
              <div className="footer__connect_item">
                ...
                <a className="footer__item_text">+7 (922) 640-16-66</a>
              </div>
            </Link>
            <Link href="mailto:perm@ms666.ru">
              <div className="footer__connect_item">
                <svg
                  width="24"
                  height="24"
                ...
                <a className="footer__item_text">perm@ms666.ru</a>
              </div>
            </Link>
            <Link href="http://www.unikum.ru">
              <a className="footer__item_text">www.unikum.ru</a>
            </Link>
          </div>
